...
reddit = praw.Reddit(client_id = 'e1LRroqJO6Ljiw', client_secret = 'Ijoju8oaO35pl67lnhzvbpoViNyBMg', username = 'Quack-Bot', password = 'REDACTED', user_agent = 'QuackBot by u/Frosty-Pqnda') # Instantiate Reddit bot
...
'I am a duck.'] # List of replies QuackBot will give when summoned
